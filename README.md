...
<body>
    ...
    <div class="card">
        <img src="nayem.png" alt="Nayem Photo">
...
<body>
    ...
    <script>
        ...
        function playMusic(id, btn) {
            ...
            // একটি বাজলে অন্যগুলো বন্ধ হয়ে যাবে
            document.querySelectorAll('audio').forEach(m => {
                if(m.id !== id) {
                    m.pause();
                    // বাটনের টেক্সট রিসেট করা
                    let b = m.nextElementSibling;
                    if(m.id === "audio1") b.innerText = "▶ Play Music 1";
                    else if(m.id === "audio2") b.innerText = "▶ Play Music 2";
                    else if(m.id === "audio3") b.innerText = "▶ Play Music 3";
                }
            });
